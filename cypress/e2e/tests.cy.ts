...
describe('Time, Fuel, Distance', () => {
	it('Standard temp. 1', () => {
		cy.get('#tfd-startalt').type('5000')
		cy.get('#tfd-starttemp').type('5')
		cy.get('#tfd-endalt').type('9500')
		cy.get('#tfd-endtemp').type('-4')
		cy.get('#tfd-res-t').should('contain.text', '10.5')
		cy.get('#tfd-res-f').should('contain.text', '1.75')
		cy.get('#tfd-res-f-taxi').should('contain.text', '3.15')
		cy.get('#tfd-res-d').should('contain.text', '14.5')
		cy.get('#tfd-b-t').should('contain.text', '8')
		cy.get('#tfd-b-f').should('contain.text', '1.9')
		cy.get('#tfd-b-d').should('contain.text', '10')
		cy.get('#tfd-t-t').should('contain.text', '18.5')
		cy.get('#tfd-t-f').should('contain.text', '3.65')
		cy.get('#tfd-t-d').should('contain.text', '24.5')
	})
	it('Standard temp. 2', () => {
		cy.get('#tfd-startalt').type('2300')
		cy.get('#tfd-starttemp').type('10.4')
		cy.get('#tfd-endalt').type('8500')
		cy.get('#tfd-endtemp').type('-2')
		cy.get('#tfd-res-t').should('contain.text', '12.2')
		cy.get('#tfd-res-f').should('contain.text', '2.28')
		cy.get('#tfd-res-f-taxi').should('contain.text', '3.68')
		cy.get('#tfd-res-d').should('contain.text', '15.9')
		cy.get('#tfd-b-t').should('contain.text', '3.3')
		cy.get('#tfd-b-f').should('contain.text', '.92')
		cy.get('#tfd-b-d').should('contain.text', '4.6')
		cy.get('#tfd-t-t').should('contain.text', '15.5')
		cy.get('#tfd-t-f').should('contain.text', '3.2')
		cy.get('#tfd-t-d').should('contain.text', '20.5')
	})
	it('Upper difference 1', () => {
		cy.get('#tfd-startalt').type('')
		cy.get('#tfd-starttemp').type('')
		cy.get('#tfd-endalt').type('')
		cy.get('#tfd-endtemp').type('')
		cy.get('#tfd-res-t').should('contain.text', '')
		cy.get('#tfd-res-f').should('contain.text', '')
		cy.get('#tfd-res-f-taxi').should('contain.text', '')
		cy.get('#tfd-res-d').should('contain.text', '')
		cy.get('#tfd-b-t').should('contain.text', '')
		cy.get('#tfd-b-f').should('contain.text', '')
		cy.get('#tfd-b-d').should('contain.text', '')
		cy.get('#tfd-t-t').should('contain.text', '')
		cy.get('#tfd-t-f').should('contain.text', '')
		cy.get('#tfd-t-d').should('contain.text', '')
	})
	it('Upper difference 2', () => {
		cy.get('#tfd-startalt').type('')
		cy.get('#tfd-starttemp').type('')
		cy.get('#tfd-endalt').type('')
		cy.get('#tfd-endtemp').type('')
