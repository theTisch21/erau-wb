...
<main>
	...
	<body>
		<div id="header">
			...
			<p>
				<strong>Please note again:</strong> These numbers from ETA are up to date as of June 8 2024,
				but may not be completely up to date. <br />Please double-check with the POH during your
				preflight or check with the numbers on ETA to ensure accurate calculations.
			</p>
			<p>
